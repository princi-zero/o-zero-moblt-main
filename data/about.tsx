...
export const teamSectionData: TeamSectionData = {
  ...
  members: [
    { id: 1, name: "Vijay Ganagam",     role: "Chief Executive Officer",      image: { src: "/images/about/section4-d1.png",  alt: "Vijay Ganagam"     }, linkedinHref: "https://in.linkedin.com/in/vijay-ganagam" },
    { id: 2, name: "Alfred Lazarus",    role: "Chief Visionary Officer",      image: { src: "/images/about/section4-d2.png",  alt: "Alfred Lazarus"    }, linkedinHref: "https://in.linkedin.com/in/alfred-jerome-lazarus" },
    { id: 3, name: "Abhinav Dantuluri", role: "Chief of Staff",      image: { src: "/images/about/section4-cos.png", alt: "Abhinav Dantuluri" }, linkedinHref: "https://in.linkedin.com/in/abhinav-dantuluri-a4a38a119" },
    { id: 4, name: "Manish Kumar",      role: "Chief Technology Officer",      image: { src: "/images/about/section4-cto.png", alt: "Manish Kumar"      }, linkedinHref: "https://in.linkedin.com/in/manish-kumar-6a2371349" },
    { id: 5, name: "Rishi Dixit",       role: "Director of Product and Growth", image: { src: "/images/about/section4-d3.png",  alt: "Rishi Dixit"       }, linkedinHref: "https://in.linkedin.com/in/riishidixit" },
  ],
};
